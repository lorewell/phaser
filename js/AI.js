...
// AI 难度设置
AI.levelConfig = {
    'simple': { depth: 2, random: 20 },   // 搜索深度2层，增加较大的随机评估偏差
    'normal': { depth: 3, random: 5 },    // 搜索深度3层（默认），少量随机
    'hard': { depth: 4, random: 0 }     // 搜索深度4层，纯理性评估
};

// 获取当前难度配置
AI.getDifficulty = function () {
    return AI.levelConfig[play.level || 'normal'];
};

//人工智能初始化
AI.init = function (pace) {
    var difficulty = AI.getDifficulty();
